...
type Template interface {
	Name() TemplateName
	Execute(content map[string]interface{}, lang string) (string, string, error)
	ContentParts() []string
	EscapeParts() []string
	Subject() string
}
...
func (p *PrecompiledTemplate) fillAndLocalize(locale string, contentPart map[string]interface{}, contextParts map[string]string) {
...
func (p *PrecompiledTemplate) Execute(content map[string]interface{}, lang string) (string, string, error) {
...
func (p *PrecompiledTemplate) fillEscapedParts(content map[string]interface{}) map[string]string {
