...
<html>
  <head>
    ...
    <title>Verify your Tidepool account</title>
  ...
  <div class='container' style='background-color:#F5F5F5; padding:20px; margin:0 auto; max-width:500px'>
    ...
    <div align='center'>
      ...
      <p style='font-family: Nunito, sans-serif, Helvetica Neue, Helvetica; font-weight:300; font-size: 14px; color:#000; line-height:1.1; padding:0 0 15px; margin:0;'>Congrats on creating your Tidepool account!</p>
      </div>
...
func NewSignupTemplate() (models.Template, error) {
	return models.NewPrecompiledTemplate(models.TemplateNameSignup, _SignupSubjectTemplate, _SignupBodyTemplate)
}
