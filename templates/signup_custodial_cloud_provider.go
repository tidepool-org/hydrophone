...
const _SignupCustodialCloudProviderSubjectTemplate string = `{{ .ClinicName }} has set up a Tidepool account for you`
const _SignupCustodialCloudProviderBodyTemplate string = `
          ...
          <tr>
            <td class="one-column" style="padding:0;">
              <table width="100%" style="border-spacing:0;color:#333333;">
                ...
                <tr>
                  <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
                    <p style="color:#281946;font-size:14px;line-height:1.5;font-weight:600;Margin-bottom:10px;Margin-left:auto;Margin-right:auto;max-width:400px;">If you have any questions about this message or Tidepool, please contact <a href="mailto:support@tidepool.org">support@tidepool.org</a> or learn more <a href="https://support.tidepool.org">here</a>.</p>
                  </td>
                </tr>
                <tr>
                  <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
...
func NewSignupCustodialCloudProviderTemplate() (models.Template, error) {
	return models.NewPrecompiledTemplate(models.TemplateNameSignupCustodialCloudProvider, _SignupCustodialCloudProviderSubjectTemplate, _SignupCustodialCloudProviderBodyTemplate)
}
