...
const _PatientClinicInviteSubjectTemplate string = `New Tidepool share invitation received`
const _PatientClinicInviteBodyTemplate string = `
                ...
                <tr>
                  <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
                    ...
                    <p class="h2 content-width" style="color:#281946;line-height:1.5;Margin:0;Margin-bottom:10px;font-size:14px;font-weight:600;Margin-bottom:28px;Margin-left:auto;Margin-right:auto;max-width:400px;">
                      {{ .CareteamName }} wants to share their data with {{ .ClinicName }}.<br/><br/>Please click the link below to add {{ .CareteamName }} to your patient list and see their data.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td class="inner centered" style="padding:0;padding:10px;text-align:center;">
                    ...
                    <td>
                    <![endif]-->
                    <a class="btn primary" href="{{ .WebURL }}/{{ .WebPath }}" style="color:#627CFF;text-decoration:none;border-radius:4px;font-size:14px;font-weight:bold;padding:10px 20px;display:inline-block;background-color:#627CFF;color:#FFFFFF;Margin-left:5px;Margin-right:5px;Margin-bottom:10px;">
...
func NewPatientClinicInviteTemplate() (models.Template, error) {
	return models.NewPrecompiledTemplate(models.TemplateNamePatientClinicInvite, _PatientClinicInviteSubjectTemplate, _PatientClinicInviteBodyTemplate)
}
